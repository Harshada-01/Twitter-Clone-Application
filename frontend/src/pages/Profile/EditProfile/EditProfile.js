    ...
    <div>
        ...
        >
          <Box sx={style} className='modal'>
            ...
            <TextField className='text-field' fullWidth label="Bio" id="fullWidth" variant='filled' onChange={(e) => setBio(e.target.value)} defaultValue={LoggedInUserr[0]?.bio ? LoggedInUser[0].bio : ''} />
